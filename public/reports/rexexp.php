            ...
            <div class="block-header">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="breadcrumb breadcrumb-style ">
                            <li class="breadcrumb-item">
                                <h4 class="page-title"> Returns of Revenue and Expenditure  </h4>
                            </li>
                            ...
                            <li class="breadcrumb-item bcrumb-2">
                                <a href="#" onClick="return false;">Revenue and Expenditure  </a>
                            </li>
                            <li class="breadcrumb-item active">Revenue and Expenditure Report</li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <strong>Revenue and Expenditure </strong> Report</h2>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered" style="font-size:12px">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                          <th colspan="8" class="center">Returns of Revenue and Expenditure for the Month of <?php $mth = $_POST['pmonth'];?><?= strtoupper(date("F", mktime(0, 0, 0, $mth, 1)));?></th>
                                        </tr>
                                        <tr>
                                            <th class="">S/N</th>
                                    ...
                                    <tbody>
                                    <?php   $sql="SELECT revenue_expenditure.*, rname 
                                                     from revenue_expenditure 
                                                   join revenuecode ON revenuecode.rcode = revenue_expenditure.rcode 
												   where  MONTH(rdate)  = '$mth' ";
