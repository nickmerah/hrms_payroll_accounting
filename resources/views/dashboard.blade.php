                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="card l-bg-blue-dark">
                        <div class="info-box-5 p-4">
                            ...
                            <div class="mb-4">
                                <h5 class="font-20 mb-0">Employees</h5>
                            </div>
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                ...
                <div class="col-xl-4 col-lg-6">
                    <div class="card l-bg-green-dark">
                        <div class="info-box-5 p-4">
                            ...
                            <div class="mb-4">
                                <h5 class="font-20 mb-0">Users</h5>
                            </div>
                            <div class="row align-items-center mb-2 d-flex">
                                <div class="col-8">
                                    <h2 class="d-flex align-items-center mb-0">
                    ...
                    <div class="card">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane body active" id="about">
                                <p class="text-default">The TCTI - PPA is the Integrated Personnel, Payroll and Accounting System for the Teachers Continuous Training Institute, Biase. Use the left navigation menu to access the functionalities of the system.</p>
                                <small class="text-muted">Help and Support: </small>
                                <p>atarahconsult@gmail.com</p>
                                <hr>
