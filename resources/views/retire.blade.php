    ...
    <section class="content">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                   <form class="form-signin" method="post"   action="{{ route('addretirement') }}" autocomplete="off">
                                @csrf
     ...
     >
                                          ...
                                          @endforeach
                                                        ...
                                                        <label for="email_address1">Item No</label>
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input type="text"  
                                                                    class="form-control"
                                                                   
                                                                   name="itemno"   required="required"
     >
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="modal fade" id="searchModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                   <form class="form-signin" method="post"   action="{{ route('sretirement') }}" autocomplete="off">
                                @csrf
