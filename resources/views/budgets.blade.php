...
@section('contents')
    <section class="content">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="breadcrumb breadcrumb-style ">
                            <li class="breadcrumb-item">
                                <h4 class="page-title">Returns Budget of Revenue & Expenditure</h4>
                            </li>
                            ...
                            <li class="breadcrumb-item bcrumb-2">
                                <a href="#" onClick="return false;">Returns Budget of Revenue & Expenditure</a>
                            </li>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                   <form class="form-signin" method="post"   action="{{ route('addreturnbudget') }}" autocomplete="off">
                                @csrf
     ...
     >
                                                          ...
                                                          <label for="email_address1">Monthly Variance</label>
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input type="text"  
                                                                    class="form-control"
                                                                   
                                                                   name="mvariance"  required="required" 
     >
                                                            </div>
                                                        </div>
                                                          <label for="email_address1">Cummulative Target</label>
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input type="text"  
                                                                    class="form-control"
                                                                   
                                                                   name="cum_target"  required="required" 
     >
                                                            </div>
                                                        </div>
                                                          <label for="email_address1">Cum Rev/Exp to Date</label>
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input type="text"  
                                                                    class="form-control"
                                                                   
                                                                   name="cum_rev_todate"  required="required" 
     >
                                                            </div>
                                                        </div>
                                                          <label for="email_address1">Cum Variance</label>
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input type="text"  
                                                                    class="form-control"
                                                                   
                                                                   name="cvariance"  required="required" 
     >
                                                            </div>
                                                        </div>
                                                          <label for="email_address1">Vote Book Balance</label>
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input type="text"  
                                                                    class="form-control"
                                                                   
                                                                   name="vbook_bal"  required="required" 
     >
                                                            </div>
                                                        </div>
                                                          <label for="email_address1">% Cumm on Target</label>
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                <input type="text"  
                                                                    class="form-control"
                                                                   
                                                                   name="pcum_target"  required="required" 
     >
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="modal fade" id="searchModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                   <form class="form-signin" method="post"   action="{{ route('sreturnbudget') }}" autocomplete="off">
                                @csrf
