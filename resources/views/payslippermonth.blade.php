...
@section('contents')
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="breadcrumb breadcrumb-style ">
                            ...
                            <li class="breadcrumb-item active">View PaySlip Per Month</li>
                        </ul>
                    </div>
                </div>
            </div><form class="form-signin" method="post"   action="{{ route('view_payslip') }}" autocomplete="off">
                                @csrf
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <strong>View</strong> PaySlip Per Month</h2>
   ...
   >
                                ...
                                <div class="col-lg-12 col-md-3 col-sm-3 col-xs-6">
                                    <div class="col-lg-8">
                                        <button class="btn btn-default submit">View PaySlip</button>
                                    </div>
                                </div>
                            </div>
                        </div>
